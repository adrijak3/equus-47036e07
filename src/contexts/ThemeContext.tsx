      ...
      <header className="sticky top-0 z-40 border-b border-gold/10 bg-background/80 backdrop-blur-md">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden items-center rounded-full border border-gold/20 bg-card/60 p-1 sm:flex">
              {(["lt", "en"] as const).map((code) => (
                <button
                  ...
                  className={cn(
                    ...
                    language === code ? "bg-gold text-background" : "text-muted-foreground hover:text-foreground",
                  )}
                >
                  {code}
                </button>
      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="mx-4 mb-4 rounded-2xl border border-gold/20 bg-card/70 p-4 sm:hidden">
              <div className="mb-3 flex items-center gap-2 text-sm font-semibold">
                <Languages className="h-4 w-4 text-gold" />
                {t("language")}
              </div>
              <div className="grid grid-cols-2 gap-2">
                <button type="button" onClick={() => setLanguage("lt")} className={cn("rounded-xl border px-3 py-2 text-sm", language === "lt" ? "border-gold bg-gold/15 text-gold" : "border-border")}>🇱🇹 Lietuvių</button>
                <button type="button" onClick={() => setLanguage("en")} className={cn("rounded-xl border px-3 py-2 text-sm", language === "en" ? "border-gold bg-gold/15 text-gold" : "border-border")}>🇬🇧 English</button>
              </div>
            </div>
                ...
                {linkedProfiles.length > 0 && (
                  <div className="space-y-1.5 pt-1">
                    ...
                    <div className="grid gap-1">
                      ...
                      >
                        <span>{profile?.full_name ?? t("me")}</span>
