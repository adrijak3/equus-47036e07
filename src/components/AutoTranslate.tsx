...
const PHRASES: Array<[string, string]> = [
  ...
  ["Registracijos būsena", "Registration status"],
  ["Laukiama administracijos patvirtinimo", "Waiting for confirmation from administration"],
  ["Administracija pasiūlė laiką – laukiama Jūsų atsakymo", "Administration proposed a time — waiting for your reply"],
  ["Administracija patvirtino laiką – laukiama Jūsų patvirtinimo", "Administration approved the time — waiting for your confirmation"],
  ["Patvirtinta ir įtraukta į tvarkaraštį", "Confirmed and added to the schedule"],
  ["Paprašėte kito laiko – administracija susisieks", "You requested another time — administration will contact you"],
  ["Pasirinkite, ką norite daryti su šiuo laiku:", "Choose what you would like to do with this time:"],
  ["Patvirtinti laiką", "Confirm the time"],
  ["Man netinka – siūlyti kitą laiką", "Does not suit me — suggest another time"],
  ["Atšaukti registraciją", "Cancel registration"],
  ["Kada Jums būtų patogu?", "When would suit you?"],
  ["Siųsti prašymą", "Send request"],
  ["Naujas prašymas", "New request"],
  ["Pasiūlytas laikas", "Proposed time"],
  ["Patvirtinta administracijos", "Approved by administration"],
  ["Klientas priėmė", "Client accepted"],
  ["Klientas patvirtino · tvarkaraštyje", "Client confirmed · in schedule"],
  ["Klientas prašo kito laiko", "Client requests another time"],
  ["Į treniruotę atvykite", "Arrive for the lesson"],
  ["30 min. prieš", "30 minutes before"],
  ["Vandenynas", "Ocean"],
  ["Levanda", "Lavender"],
  ["Vidurnaktis", "Midnight"],
  ["Mano paskyra", "My account"],
  ["Svetainės išvaizda", "Website appearance"],
  ["Sezonas, šviesumas ir spalvos", "Season, brightness and colours"],
  ["Keisti svetainės temą", "Change website theme"],
  ["Automatinė arba pasirinktas sezonas", "Automatic or selected season"],
  ["Pakamšės g. 7, Daučionys", "Pakamšės St. 7, Daučionys"],
  ["Visos teisės saugomos.", "All rights reserved."],
  ["Svetainės visos autoriaus teisės priklauso Adrijai Kalikaitei.", "All website copyrights belong to Adrija Kalikaitė."],
  ["Mylintiems žirgus ir laisvę", "For those who love horses and freedom"],
  ["Peržiūrėti visą informaciją →", "View all information →"],
  ["Svarbu prieš pirmą treniruotę", "Important before your first lesson"],
  ["Prieš pirmąją treniruotę nepamirškite pasirašyti jojimo sutarties.", "Remember to sign the riding agreement before your first lesson."],
  ["Atvykite ~30 min. prieš treniruotės laiką, dėvėkite tinkamą avalynę.", "Arrive about 30 minutes before the lesson and wear suitable footwear."],
  ["Daugiau informacijos rasite čia.", "More information is available here."],
  ["Registruodamiesi pateikite teisingą telefono numerį ir el. paštą. Į treniruotę atvykite sutartu laiku. Už nepilnamečius atsako jų atstovai. Apie sveikatos būklę ar kitą svarbią informaciją praneškite treneriui iš anksto.", "When registering, provide a valid phone number and email address. Arrive at the agreed time. A parent or guardian is responsible for minors. Tell the trainer about health conditions or other important information in advance."],
  ["Atšakimas galimas 24 val. prieš treniruotę. Pavėluotai atšaukta treniruotė yra skaičiuojama kaip panaudota, jei priežastis nėra vieną iš šių - liga, force majeure atvejis.", "Cancellation is allowed at least 24 hours before the lesson. A late-cancelled lesson counts as used unless the reason is illness or force majeure."],
  ["Atšaukimas galimas 24 val. prieš treniruotę.", "Cancellation is allowed at least 24 hours before the lesson."],
  ["Perskaitykite dokumentą iki apačios.", "Read the document to the bottom."],
  ["Telefonas patvirtinimui", "Phone number for verification"],
  ["Naudojamas slaptažodžio atstatymui", "Used for password recovery"],
  ["Įveskite el. paštą arba telefoną", "Enter your email or phone number"],
  ["Įveskite slaptažodį", "Enter your password"],
  ["Laba diena", "Hello"],
  ["Sveiki sugrįžę", "Welcome back"],
  ["Pamokų sk.", "No. of lessons"],
  ["Pamokų skaičius", "Number of lessons"],
  ["Jau panaudota treniruočių", "Lessons already used"],
  ["Galioja 30 dienų", "Valid for 30 days"],
  ["Naujas abonementas", "New lesson package"],
  ["Abonementai", "Lesson packages"],
  ["Abonementas", "Lesson package"],
  ["Nėra aktyvių abonementų", "No active lesson packages"],
  ["Pamokos baigėsi — pridėkite naują abonementą", "No lessons remain — add a new lesson package"],
  ["Pamokų istorija", "Lesson history"],
  ["Įtraukti į šį abonementą (nuo pirkimo dienos)", "Include in this package (from purchase date)"],
  ["Auto-priskirti šio abonemento įvykusias", "Automatically assign completed lessons to this package"],
  ["Pažymėkite jau įvykusias treniruotes (įsk. šiandienos), kurios turėtų skaičiuotis šiame abonemente.", "Select completed lessons, including today's, that should count toward this package."],
  ["Jeigu šio abonemento jau buvote panaudoję — įrašykite kiek. Naujam abonementui palikite 0.", "Enter how many lessons from this package have already been used. Leave 0 for a new package."],
  ["Spauskite, kad pažymėtumėte kaip apmokėtą", "Click to mark as paid"],
  ["Jau apmokėta", "Already paid"],
  ["Iš viso treniruočių", "Total lessons"],
  ["Iš viso", "Total"],
  ["Įskaičiuota", "Counted"],
  ["Įskaičiuotos pamokos", "Counted lessons"],
  ["Atšauktos / nesiskaičiuoja", "Cancelled / not counted"],
  ["Atšauktų", "Cancelled"],
  ["Aktyvios ir būsimos", "Active and upcoming"],
  ["Šį mėnesį pamokų nėra.", "There are no lessons this month."],
  ["treniruočių šį mėnesį", "lessons this month"],
  ["TOP vartotojai (šį mėn.)", "Top users (this month)"],
  ["Žirgų krūvis (šį mėn.)", "Horse workload (this month)"],
  ["Pasirinktos dienos žirgų krūvis", "Horse workload for the selected day"],
  ["Dienos limitas", "Daily limit"],
  ["Dienos limitas pasiektas", "Daily limit reached"],
  ["Maks. jojimų per dieną", "Maximum rides per day"],
  ["kiek kartų žirgas jau priskirtas tą dieną / jo limitas", "how many times the horse is already assigned that day / its limit"],
  ["Žirgų sąrašas", "Horse list"],
  ["Žirgų nerasta.", "No horses found."],
  ["Žirgo vardas", "Horse name"],
  ["Paskirti žirgus", "Assign horses"],
  ["— žirgas dar nepaskirtas —", "— horse not assigned yet —"],
  ["Užsiregistravę", "Booked riders"],
  ["Nėra užsiregistravusių", "No booked riders"],
  ["Šiai dienai nėra užsiregistravusių.", "There are no bookings for this day."],
  ["Jūsų rezervacija", "Your booking"],
  ["Pastovi vieta (paryškintas vardas)", "Recurring place (name shown in bold)"],
  ["Svečio rezervacija nesusieta su jokiu vartotoju ir neskaičiuoja abonemento.", "A guest booking is not linked to a user and does not use a lesson package."],
  ["Talpos limitas ignoruojamas. Norint pridėti +1 vietą, naudokite +1 mygtuką.", "The capacity limit is ignored. Use the +1 button to add one extra place."],
  ["Naujas laikas", "New time"],
  ["Naujas nuolatinis laikas", "New recurring time"],
  ["Nuolatinis laikas", "Recurring time"],
  ["Tik šiai dienai", "For this day only"],
  ["Kas savaitę", "Every week"],
  ["Visoms savaitėms (visada)", "For all weeks (permanently)"],
  ["Vienkartinis laikas — bus rodomas tik šią dieną.", "A one-time slot will only be shown on this day."],
  ["Diena (kas savaitę)", "Day (weekly)"],
  ["Pasirinkite dieną", "Select a day"],
  ["Pakeis nuolatinį šabloną — nuo dabar visos savaitės.", "This changes the recurring template for all weeks from now on."],
  ["Vienkartinis atšaukimas — kitos savaitės liks.", "This cancels one occurrence; future weeks remain unchanged."],
  ["Kitos savaitės nebus paveiktos.", "Other weeks will not be affected."],
  ["Visos būsimos pamokos šiuo laiku bus atšauktos.", "All future lessons at this time will be cancelled."],
  ["Tai jūsų nuolatinis laikas. Ką norite daryti?", "This is your recurring time. What would you like to do?"],
  ["Slot atsilaisvins iš karto. Administracija nuspręs, ar pamoka skaičiuojama abonemente.", "The slot will become available immediately. Administration will decide whether the lesson counts toward the package."],
  ["Atidirbti šią savaitę", "Make up the lesson this week"],
  ["Laiko keitimas", "Change time"],
  ["NEskaičiuoti", "Do not count"],
  ["Skaičiuoti", "Count"],
  ["Grąžinti dieną", "Restore day"],
  ["Dienos video", "Day video"],
  ["Video dar nėra", "No video yet"],
  ["video nuorodos automatiškai ištrinamos po 2 dienų", "video links are automatically deleted after 2 days"],
  ["Prisijunkite, kad galėtumėte pridėti video nuorodą.", "Sign in to add a video link."],
  ["Šios dienos nuolatinės žinutės", "Recurring messages for this day"],
  ["Nėra žinučių", "No messages"],
  ["Žinute administracijai", "Message administration"],
  ["Pokalbiai automatiškai ištrinami po 3 dienų nuo paskutinės žinutės.", "Conversations are automatically deleted 3 days after the last message."],
  ["Pažymėti perskaityta", "Mark as read"],
  ["Nėra laukiančių prašymų", "No pending requests"],
  ["Pažiūrėti pažymą", "View document"],
  ["Priežastis:", "Reason:"],
  ["Galima įkelti vėliau paskyroje (per 7 d.).", "You can upload it later in your account within 7 days."],
  ["Laukiama pažymos iki", "Medical document due by"],
  ["Įkelti pažymą iki:", "Upload document by:"],
  ["Užregistruotos atostogos", "Registered holidays"],
  ["Nėra užregistruotų atostogų.", "No registered holidays."],
  ["Šiuo metu niekas nėra atostogose.", "Nobody is currently on holiday."],
  ["Susiejimų nėra", "No linked profiles"],
  ["Susiek du profilius", "Link two profiles"],
  ["Tėvinė paskyra", "Parent account"],
  ["Vardas tvarkaraštyje", "Name shown in schedule"],
  ["Numatytas vaizdas: vardas + pirmos 2 pavardės raidės", "Default display: first name + first 2 letters of the surname"],
  ["Įveskite savo telefono numerį", "Enter your phone number"],
  ["turi sutapti su paskyroje nurodytu", "it must match the number in your account"],
  ["— pasirinkite vartotoją —", "— select a user —"],
  ["— pasirinkite —", "— select —"],
  ["Visi vartotojai", "All users"],
  ["Vartotojai", "Users"],
  ["Nėra duomenų", "No data"],
  ["Nėra", "None"],
  ["Niekas neturi nuolatinių laikų", "Nobody has recurring times"],
  ["Šiuo metu neturite nuolatinių laikų", "You currently have no recurring times"],
  ["Nuolatiniai laikai – tai jūsų savaitiniai treniruočių laikai, į kuriuos esate automatiškai užregistruojama kiekvieną savaitę.", "Recurring times are your weekly lesson slots, which are booked automatically every week."],
  ["Ištrinti", "Delete"],
  ["Pasenusių vienkartinių laikų nėra", "There are no expired one-time slots"],
  ["Sportinė (8 → 30€/pam, kitaip 35€)", "Sport package (8 → €30/lesson, otherwise €35)"],
  ["Sportinė", "Sport"],
  ["≤ 7 treniruotės — 35 € / treniruotė", "≤ 7 lessons — €35 per lesson"],
  ["Mažylio svajonė", "Little Rider's Dream"],
  ["Praėjusi savaitė", "Previous week"],
  ["Kita savaitė", "Next week"],
  ["Savaitė", "Week"],
  ["Sąrašas", "List"],
  ["Treniruočių nėra", "No lessons"],
  ["Šiandien", "Today"],
  ["šiandien", "today"],
  ["Pradžia", "Home"],
  ["Paskyra", "Account"],
  ["Prisijungta kaip", "Signed in as"],
  ["Prisijungti", "Sign in"],
  ["Registruotis", "Register"],
  ["arba", "or"],
  ["susikurkite paskyrą", "create an account"],
  ["norėdami registruotis į pamokas.", "to book lessons."],
  ["Trenerio sritis", "Trainer area"],
  ["Aš", "Me"],
  ["Diena", "Day"],
  ["Atšaukimas", "Cancellation"],
  ["Žiema", "Winter"],
  ["Balandžio", "April"],
  ["Birželio", "June"],
  ["Rugpjūčio", "August"],
  ...
  ["Št", "Sat"],
  ["Siųsti", "Send"],
  ["Įvesk skaitmenis — dvitaškis pridedamas automatiškai (pvz. 1730 → 17:30).", "Enter digits; the colon is added automatically (e.g. 1730 → 17:30)."],
