...
export function ImportantUpdatePopup() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center bg-background/45 p-4 pt-2 sm:pt-[5vh] backdrop-blur-[2px] animate-in fade-in duration-300">
