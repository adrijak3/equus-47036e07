  ...
  const load = async () => {
    ...
    if (bs.length) {
      ...
      const withMeta = bs.map((x) => {
        ...
        const price = kind === "individual" ? (x.slot_date >= "2026-09-01" ? 50 : 40) : calculateSubPriceByType(1, kind === "po2" ? "sportine_po2" : "sportine");
